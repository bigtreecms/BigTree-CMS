...
?>
<fieldset>
	<label for="<?=$image_options_prefix?>preset_select"><?=Text::translate("Existing Preset")?></label>
	...
	<fieldset>
		<div class="image_attr" id="<?=$image_options_prefix?>pop_crop_list">
			...
			<ul>
				...
				<li class="actions">
					<a href="#<?=$crop_count?>" title="<?=$text_centered_subcrop?>" class="subcrop"></a>
					<a href="#<?=$crop_count?>" title="<?=$text_thumbnail_crop?>" class="thumbnail"></a>
					<input type="hidden" name="crops[<?=$crop_count?>][grayscale]" value="<?=$crop["grayscale"]?>" />
					<a href="#" title="<?=$text_color_mode?>" class="color_mode<?php if ($crop["grayscale"]) { ?> gray<?php } ?>"></a>
					<a href="#<?=$crop_count?>" title="<?=$text_remove?>" class="delete"></a>
				</li>
			</ul>
			<div class="image_attr_crop_thumbs">
				...
				<ul class="image_attr_thumbs_<?=$crop_count?>">
					...
					<li class="actions">
						...
						<a href="#" title="<?=$text_color_mode?>" class="color_mode<?php if ($thumb["grayscale"]) { ?> gray<?php } ?>"></a>
						<a href="#" title="<?=$text_remove?>" class="delete"></a>
					</li>
				</ul>
				<?php
									}
			...
			<div class="image_attr_crop_center_crops">
				...
				<ul class="image_attr_thumbs_<?=$crop_count?>">
					...
					<li class="actions">
						...
						<a href="#" title="<?=$text_color_mode?>" class="color_mode<?php if ($center_crop["grayscale"]) { ?> gray<?php } ?>"></a>
						<a href="#" title="<?=$text_remove?>" class="delete"></a>
					</li>
				</ul>
				<?php
		...
		<div class="image_attr" id="<?=$image_options_prefix?>pop_center_crop_list">
			...
			<ul>
				...
				<li class="actions for_thumbnail">
					...
					<a href="#" title="<?=$text_color_mode?>" class="color_mode<?php if ($crop["grayscale"]) { ?> gray<?php } ?>"></a>
					<a href="#<?=$center_crop_count?>" title="<?=$text_remove?>" class="delete"></a>
				</li>
			</ul>
			<?php
						}
