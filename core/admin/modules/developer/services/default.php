...
<div class="table">
	...
	<section>
		<a class="box_select<?php if ($twitter->Connected) {
    ?> connected<?php 
}
	    ?>" href="twitter/">
		...
		<a class="box_select<?php if ($instagram->Connected) {
    ?> connected<?php 
}
	    ?>" href="instagram/">
		...
		<a class="box_select<?php if ($google->Connected) {
    ?> connected<?php 
}
	    ?>" href="googleplus/">
		...
		<a class="box_select<?php if ($youtube->Connected) {
    ?> connected<?php 
}
	    ?>" href="youtube/">
		...
		<a class="box_select<?php if ($flickr->Connected) {
    ?> connected<?php 
}
	    ?>" href="flickr/">
		...
		<a class="box_select<?php if ($disqus->Connected) {
    ?> connected<?php 
}
	    ?>" href="disqus/">
		...
		<a class="box_select last<?php if ($salesforce->Connected) {
    ?> connected<?php 
}
	    ?>" href="salesforce/">
