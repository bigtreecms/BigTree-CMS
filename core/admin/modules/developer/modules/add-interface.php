		...
		<section>
			<div class="contain">
				<div class="left">
					...
					<a href="<?=DEVELOPER_ROOT?>modules/views/add/?module=<?=$_GET["module"]?>" class="button">Add View</a>
				</div>
				<div class="right">
					...
					<a href="<?=DEVELOPER_ROOT?>modules/reports/add/?module=<?=$_GET["module"]?>" class="button">Add Report</a>
				</div>
			</div>
			<hr />
			<div class="contain">
				<div class="left">
					...
					<a href="<?=DEVELOPER_ROOT?>modules/forms/add/?module=<?=$_GET["module"]?>" class="button">Add Form</a>
				</div>
				<div class="right">
					...
					<a href="<?=DEVELOPER_ROOT?>modules/embeds/add/?module=<?=$_GET["module"]?>" class="button">Add Embeddable Form</a>
				</div>
			</div>
		</section>
	</div>
