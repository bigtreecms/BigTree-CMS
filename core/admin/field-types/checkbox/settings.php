...
<fieldset>
	...
	<label for="settings_field_default_on" class="for_checkbox"><?=Text::translate("Default to Checked")?></label>
</fieldset>

<fieldset>
	<label for="settings_field_value"><?=Text::translate('Value <small>(defaults to "on")</small>')?></label>
