...
<div class="container">
	<summary>
		...
		<h2><?=Text::translate("Caching existing Amazon S3 file database")?></h2>
	</summary>
	<section>
		<p class="cache_message"><?=Text::translate("Please wait while BigTree caches existing filenames to prevent inadvertantly overwriting existing files.")?></p>
	</section>
</div>
...
<script>
	(function() {
		...
		var cache_message = $(".cache_message");
