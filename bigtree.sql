...
CREATE TABLE `bigtree_settings` ( `id` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '', `value` longblob NOT NULL, `type` varchar(255) COLLATE utf8_bin NOT NULL, `name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '', `description` text COLLATE utf8_bin NOT NULL, `locked` char(2) COLLATE utf8_bin NOT NULL, `system` char(2) COLLATE utf8_bin NOT NULL, `encrypted` char(2) COLLATE utf8_bin NOT NULL, `package` int(11) unsigned NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `bigtree_settings` (`id`,`value`,`system`) VALUES ('bigtree-internal-revision','1','on');
