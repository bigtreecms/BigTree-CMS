		...
		<div class="body">
			<div class="wrapper">
				...
				<div class="environment_alert">
					<span><strong>Development Site</strong> &middot; Changes Will Not Affect Live Site!</span> <? if ($bigtree["config"]["environment_live_url"] != "") { echo '<a href="'.$bigtree["config"]["environment_live_url"].'admin/">Go Live</a>'; } ?>
				</div>
				<? } ?>
