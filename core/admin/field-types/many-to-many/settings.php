...
<fieldset>
	...
	<div data-name="mtm-my-id" class="pop-dependant mtm-connecting-table">
		<?php if (!empty($settings["mtm-connecting-table"])) { ?>
...
<fieldset>
	...
	<div id="settings_field_other_descriptor" data-name="mtm-other-descriptor" class="pop-dependant mtm-other-table">
		<?php if (!empty($settings["mtm-other-table"])) { ?>
...
<fieldset id="settings_fieldset_add_all"<?php if (!empty($settings["max"])) { ?> style="display: none;"<?php } ?>>
	<input id="settings_field_add_all" type="checkbox" name="show_add_all"<?php if (!empty($settings["show_add_all"])) { ?> checked="checked"<?php } ?>>
...
<fieldset>
	<input id="settings_field_reset" type="checkbox" name="show_reset"<?php if (!empty($settings["show_reset"])) { ?> checked="checked"<?php } ?>>
