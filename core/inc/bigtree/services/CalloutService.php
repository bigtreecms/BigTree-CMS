<?php
	...
	class CalloutService {
		...
		public function get(Request $request) {
			...
			if (!$c) throw new NotFoundException("Callout $id not found", "resource_not_found", 404);
		...
		public function update(Request $request) {
			...
			if (!$existing) throw new NotFoundException("Callout $id not found", "resource_not_found", 404);
		...
		public function getGroup(Request $request) {
			...
			if (!$g) throw new NotFoundException("Callout group $id not found", "resource_not_found", 404);
		...
		public function updateGroup(Request $request) {
			...
			if (!$existing) throw new NotFoundException("Callout group $id not found", "resource_not_found", 404);
			$d = $request->body;
			$next = array_merge($existing, [
				"name" => isset($d["name"]) ? BigTree::safeEncode($d["name"]) : $existing["name"],
