...
CREATE TABLE `bigtree_field_types` (`id` varchar(255) NOT NULL DEFAULT '',`name` varchar(255) NOT NULL,`pages` char(2) NOT NULL,`modules` char(2) NOT NULL,`callouts` char(2) NOT NULL DEFAULT '',`settings` char(2) NOT NULL DEFAULT '',`package` int(11) unsigned NOT NULL,PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `bigtree_module_actions` (`id` int(11) unsigned NOT NULL auto_increment, `module` int(11) unsigned NOT NULL default '0', `name` varchar(255) collate utf8_bin NOT NULL default '', `route` varchar(255) collate utf8_bin NOT NULL default '', `in_nav` char(2) collate utf8_bin NOT NULL default '', `form` int(11) unsigned NOT NULL, `view` int(11) unsigned NOT NULL, `class` varchar(255) collate utf8_bin NOT NULL, `level` int(11) NOT NULL, `position` int(11) NOT NULL, PRIMARY KEY  (`id`), KEY `module` (`module`), KEY `route` (`route`), KEY `in_nav` (`in_nav`), KEY `position` (`position`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `bigtree_module_groups` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT,`name` varchar(255) NOT NULL,`route` varchar(255) NOT NULL,`in_nav` char(2) NOT NULL,`position` int(11) NOT NULL DEFAULT '0',`package` int(11) unsigned NOT NULL,PRIMARY KEY (`id`),KEY `route` (`route`),KEY `in_nav` (`in_nav`),KEY `position` (`position`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

DROP TABLE IF EXISTS `bigtree_module_view_cache`;
CREATE TABLE `bigtree_module_view_cache` (`view` int(11) unsigned NOT NULL,`id` varchar(255) NOT NULL,`gbp_field` text NOT NULL,`group_field` text NOT NULL,`group_sort_field` text NOT NULL,`position` int(11) NOT NULL,`approved` char(2) NOT NULL,`archived` char(2) NOT NULL,`featured` char(2) NOT NULL,`status` char(1) NOT NULL DEFAULT '',`pending_owner` int(11) unsigned NOT NULL,`column1` text NOT NULL,`column2` text NOT NULL,`column3` text NOT NULL,`column4` text NOT NULL,`column5` text NOT NULL,KEY `view` (`view`),KEY `group_field` (`group_field`(200)),KEY `group_sort_field` (`group_sort_field`(200)),KEY `id` (`id`),KEY `position` (`position`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `bigtree_modules` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT,`group` int(11) unsigned NOT NULL DEFAULT '0',`name` varchar(255) NOT NULL DEFAULT '',`description` text NOT NULL,`image` varchar(255) NOT NULL DEFAULT '',`route` varchar(255) NOT NULL DEFAULT '',`class` varchar(255) NOT NULL DEFAULT '',`gbp` text NOT NULL,`position` int(11) NOT NULL,`package` int(11) unsigned NOT NULL,PRIMARY KEY (`id`),KEY `group` (`group`),KEY `route` (`route`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `bigtree_settings` ( `id` varchar(255) NOT NULL DEFAULT '', `value` longblob NOT NULL, `type` varchar(255) NOT NULL, `options` longtext NOT NULL, `name` varchar(255) NOT NULL DEFAULT '', `description` text NOT NULL, `locked` char(2) NOT NULL, `system` char(2) NOT NULL, `encrypted` char(2) NOT NULL, `package` int(11) unsigned NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `bigtree_templates` (`id` varchar(255) NOT NULL DEFAULT '',`name` varchar(255) NOT NULL DEFAULT '',`description` text NOT NULL,`routed` char(2) NOT NULL,`image` varchar(255) NOT NULL DEFAULT '',`resources` text NOT NULL,`callouts_enabled` char(2) NOT NULL DEFAULT '',`module` int(11) unsigned NOT NULL,`level` int(11) unsigned NOT NULL,`position` int(11) NOT NULL DEFAULT '0',`package` int(11) unsigned NOT NULL,PRIMARY KEY (`id`),KEY `routed` (`routed`),KEY `position` (`position`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
