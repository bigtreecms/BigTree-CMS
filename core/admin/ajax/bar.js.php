...
var BigTreeBar = {
	...
	show: function() {
		...
		<? } ?>
		bigtree_bar_html += '<a href="#" id="bigtree_bar_close"></a><a href="<?=ADMIN_ROOT?>login/logout/" id="bigtree_logout">Logout</a><span id="bigtree_name"><?=htmlspecialchars(strip_tags($_GET["username"]))?></span>';
		<? if ($_GET["previewing"]) { ?>
