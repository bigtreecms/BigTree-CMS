<?php
	...
	$info = array_filter((array) @json_decode(cURL::request("http://www.bigtreecms.org/ajax/extensions/version/?extensions[]=".$_GET["id"], false, [CURLOPT_CONNECTTIMEOUT => 1, CURLOPT_TIMEOUT => 5]), true));
