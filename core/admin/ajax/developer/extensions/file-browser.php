...
<div class="navigation_pane">
    ...
    ?>
		<li><a data-type="location" href="<?=$option['class']?>"<?php if ($location == $option['class']) {
    ?> class="active"<?php 
}
    ?>><span class="icon_small icon_small_<?=$option['class']?>"></span><?=$option['title']?></a></li>
		<?php 
}
    ?>
	</ul>
	...
	<ul>
		<?php
			foreach ($files as $file) {
			    ...
			    ?>
		<li class="file<?php if ($file == $_POST['file']) {
    ?> selected<?php 
}
			    ?>"><span class="icon_small icon_small_file_default icon_small_file_<?=$ext?>"></span><p><?=$file?></p></li>
		<?php
