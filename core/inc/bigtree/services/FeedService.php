<?php
	...
	class FeedService {
		...
		public function get(Request $request) {
			...
			if (!$f) throw new NotFoundException("Feed $id not found", "resource_not_found", 404);
		...
		public function update(Request $request) {
			...
			if (!$existing) throw new NotFoundException("Feed $id not found", "resource_not_found", 404);
			$d = $request->body;
