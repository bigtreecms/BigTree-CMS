...
?>
<div class="container">
	<header><p><?=Text::translate("Add additional files and tables to your package.")?></p></header>
			...
			<article class="package_column package_column_double package_column_last">
				...
				<ul>
					...
					<li>
						...
						<a href="#" class="icon_small icon_small_delete"></a>
						<a href="#<?=$table?>" class="icon_small <?php if ($type == "with-data") { ?>icon_small_export<?php } else { ?>icon_small_list<?php } ?>" title="<?php if ($type == "with-data") { ?>Structure &amp; Data<?php } else { ?>Structure Only<?php } ?>"></a>
						<?=$table?>
					</li>
					<?php
						}
