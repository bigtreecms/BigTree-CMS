<?
	...
	$admin->updateModuleEmbedForm(end($bigtree["path"]),$title,$table,$fields,json_decode($_POST["hooks"]),$default_position,$default_pending,$css,$redirect_url,$thank_you_message);
