<?php
	...
	class TemplateService {
		...
		public function get(Request $request) {
			...
			if (!$t) throw new NotFoundException("Template $id not found", "resource_not_found", 404);
		...
		public function update(Request $request) {
			...
			if (!$existing) throw new NotFoundException("Template $id not found", "resource_not_found", 404);
