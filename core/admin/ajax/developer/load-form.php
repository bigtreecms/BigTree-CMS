...
<div class="form_table<?php if (!$positioned) {
    ?> last<?php 
}
	    ?>">
	<header>
	...
	<ul id="resource_table">
		...
		<li id="row_<?=$key?>">
			<section class="developer_resource_form_title">
				...
				<input type="text" name="fields[<?=$key?>][title]" <?php if ($field['type'] == 'geocoding') {
    ?>disabled="disabled" value="Geocoding"<?php 
} else {
    ?>value="<?=$field['title']?>"<?php 
}
				    ?> />
			</section>
			<section class="developer_resource_form_subtitle">
				<input type="text" name="fields[<?=$key?>][subtitle]" <?php if ($field['type'] == 'geocoding') {
    ?>disabled="disabled" value=""<?php 
} else {
    ?>value="<?=$field['subtitle']?>"<?php 
}
				    ?> />
			</section>
    ...
    ?>
						<option value="<?=$k?>"<?php if ($k == $field['type']) {
...
<fieldset class="last">
	...
	<select name="default_position">
		...
		<option<?php if ($form['default_position'] == 'Top') {
    ?> selected="selected"<?php 
}
    ?>>Top</option>
	</select>
...
<script>
    ...
    ?></optgroup><?php 
	    ...
	    ?></select><a href="#" class="options icon_settings" name="' + key + '"></a><input type="hidden" name="fields[' + key + '][options]" value="" id="options_' + key + '" /></section><section class="developer_resource_action"><a href="#" class="icon_delete" name="' + key + '"></a></section>');
