<?
	...
	$bigtree["developer_nav_links"][] = array("url" => ADMIN_ROOT."developer/modules/forms/edit/".$bigtree["form"]["id"]."/?return=front","class" => "icon_settings","title" => "Edit in Developer");
	// Audit Trail link
	if ($bigtree["edit_id"]) {
