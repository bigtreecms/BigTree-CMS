	...
	<form method="post" action="<?=DEVELOPER_ROOT?>cloud-storage/google/activate/" class="module" enctype="multipart/form-data">
		...
		<section>
			...
			<ol>
				...
				<li><?=Text::translate('Enter :redirect_uri: as an "Authorized Redirect URI" and choose "Web Application" for the Application Type.', false, [":redirect_uri:" => DEVELOPER_ROOT."cloud-storage/google/return/"])?></li>
