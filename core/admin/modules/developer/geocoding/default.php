...
<div class="table">
	...
	<section>
		...
		<a class="box_select<?php if ($gateway["service"] == "yahoo") { ?> connected<?php } ?>" href="<?=DEVELOPER_ROOT?>geocoding/yahoo/">
		...
		<a class="box_select<?php if ($gateway["service"] == "yahoo-boss") { ?> connected<?php } ?>" href="<?=DEVELOPER_ROOT?>geocoding/yahoo-boss/">
