<?php
	...
	if (isset($_POST['template'])) {
	    ?>
<fieldset>
	<input type="checkbox" name="seo_body"<?php if ($data['seo_body']) {
    ?> checked="checked"<?php 
}
	    ?> />
...
?>
<fieldset>
	<input type="checkbox" name="simple"<?php if ($data['simple']) {
    ?> checked="checked"<?php 
} ?> />
...
<fieldset>
	...
	<select name="simple_by_permission">
		...
		<option value="1"<?php if ($sbp == '1') {
    ?> selected="selected"<?php 
} ?>>Administrator</option>
		<option value="2"<?php if ($sbp == '2') {
    ?> selected="selected"<?php 
} ?>>Developer</option>
	</select>
</fieldset>
