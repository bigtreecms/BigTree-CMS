	...
	<div class="image_attr" id="pop_crop_list">
		...
		<ul>
			...
			<li class="actions">
				...
				<a href="#" title="Switch Color Mode" class="disabled color_mode<?php if ($crop['grayscale']) {
    ?> gray<?php 
}
					    ?>"></a>
		...
		<ul class="image_attr_thumbs_<?=$crop_count?>">
			...
			<li class="actions">
				...
				<a href="#" title="Switch Color Mode" class="disabled color_mode<?php if ($thumb['grayscale']) {
    ?> gray<?php 
}
								    ?>"></a>
