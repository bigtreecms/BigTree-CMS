...
CREATE TABLE `bigtree_open_graph` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT, `table` varchar(255) NOT NULL DEFAULT '', `entry` int(11) unsigned NOT NULL, `type` varchar(255) DEFAULT NULL, `title` varchar(255) DEFAULT NULL, `description` text, `image` varchar(255) DEFAULT NULL, `image_width` int(11) DEFAULT NULL, `image_height` int(11) DEFAULT NULL, PRIMARY KEY (`id`), KEY `table` (`table`), KEY `entry` (`entry`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `bigtree_settings` (`id`,`value`) VALUES ('bigtree-internal-revision','408');
