		...
		<section>
			<div class="contain">
				<div class="left">
					...
					<fieldset>
						<input type="checkbox" name="password[mixedcase]"<?php if ($password['mixedcase']) {
    ?> checked="checked"<?php 
} ?> />
						<label class="for_checkbox">Require Mixed-Case <small>(both lowercase and uppercase characters)</small></label>
					</fieldset>
					<fieldset>
						<input type="checkbox" name="password[numbers]"<?php if ($password['numbers']) {
    ?> checked="checked"<?php 
} ?> />
						<label class="for_checkbox">Require Numbers</label>
					</fieldset>
					<fieldset>
						<input type="checkbox" name="password[nonalphanumeric]"<?php if ($password['nonalphanumeric']) {
    ?> checked="checked"<?php 
} ?> />
