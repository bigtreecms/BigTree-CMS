...
*/
		...
		_mceInsertAnchor : function(ui, v) {
			...
			ed.windowManager.open({
				...
				width : 380 + parseInt(ed.getLang('advanced.anchor_delta_width', 0)),
				height : 145 + parseInt(ed.getLang('advanced.anchor_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
		...
		_mceLink : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 330 + parseInt(ed.getLang('advanced.link_delta_width', 0)),
