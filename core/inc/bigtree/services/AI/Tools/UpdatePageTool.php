					...
					"properties" => [
						...
						"og_type" => [
							...
							"description" => "Open Graph type, which tells a social network what kind of thing this "
								. "page is. One of: website, article, profile, video.movie. Empty string clears it.",
							"enum" => OpenGraphDomain::TYPES,
						],
						"og_image" => [
							"type" => "string",
							"description" => "Open Graph image: the full URL of an image to show when the page is "
