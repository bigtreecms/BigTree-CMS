				...
				<div className="mx-auto max-w-screen-2xl px-6 py-8">
					<div className="rounded-md border border-danger/30 bg-danger-bg p-4 text-[13px]">
						...
						<button
							...
							className="mt-3 inline-flex items-center gap-1.5 rounded-md border border-border bg-surface px-3 py-1.5 text-[12.5px] font-medium text-text hover:bg-surface-2"
						>
							<RotateCcw size={13} />
							Try again
						</button>
