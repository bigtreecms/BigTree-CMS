<nav class="sub">
	<ul>
		<li><a href="<?=$mroot?>"<? if (end($bigtree["path"]) == "analytics") { ?> class="active"<? } ?>><span class="icon_small icon_small_clock"></span>Traffic Report</a></li>
		<li><a href="<?=$mroot?>service-providers/"<? if (end($bigtree["path"]) == "service-providers") { ?> class="active"<? } ?>><span class="icon_small icon_small_broadcast"></span>Service Providers</a></li>
