<?php
	...
	$text_default = Text::translate("Default", true);
	$text_custom = Text::translate("Custom", true);
...
<form method="post" action="<?=DEVELOPER_ROOT?>files/update-metadata/" class="js-metadata-form">
	<div class="container">
		<summary>
			<h2><?=Text::translate("Metadata")?></h2>
		</summary>
	
		<section>
			<h3><?=Text::translate("Generic Files Metadata")?></h3>
			...
			<h3><?=Text::translate("Image Metadata")?></h3>
			...
			<h3><?=Text::translate("Video Metadata")?></h3>
		...
		<footer>
			<input type="submit" value="<?=Text::translate("Update Metadata Fields", true)?>" class="button blue">
		</footer>
	</div>
</form>
