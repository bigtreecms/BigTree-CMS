...
<div class="container">
    ...
    ?>
				<option value="<?=htmlspecialchars($container['name'])?>"<?php if ($storage->Settings->Container == $container['name'] && $storage->Settings->Service == $_POST['service']) {
    ?> selected="selected"<?php 
}
    ?>><?=htmlspecialchars($container['name'])?></option>
				<?php 
}
	        ?>
			</select>
