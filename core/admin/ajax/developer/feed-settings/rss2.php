...
<fieldset>
	<label for="settings_field_date_field"><?=Text::translate("Date Field")?></label>
	<select id="settings_field_date_field" name="date">
		<?php SQL::drawColumnSelectOptions($table, $settings["date"]); ?>
	</select>
</fieldset>
<fieldset>
	<label for="settings_field_creator_field"><?=Text::translate("Creator Field")?></label>
	<select id="settings_field_creator_field" name="creator">
		<?php SQL::drawColumnSelectOptions($table, $settings["creator"]); ?>
	</select>
</fieldset>
<fieldset>
