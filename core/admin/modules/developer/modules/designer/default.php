...
<div class="container">
    ...
    ?>
					<option value="<?=$group['id']?>"<?php if ($group_existing == $group['id']) {
    ...
    ?>><?=$group['name']?></option>
			...
			<div class="left">
				<fieldset<?php if (isset($e['table'])) {
    ?> class="form_error"<?php 
} ?>>
					<label class="required">Table Name <small>(for example, my_site_news)</small><?php if (isset($e['table'])) {
    ?><span class="form_error_reason">Table Already Exists</span><?php 
} ?></label>
					<input name="table" class="required" type="text" value="<?=$table?>" />
				</fieldset>
				<fieldset<?php if (isset($e['class'])) {
    ?> class="form_error"<?php 
} ?>>
					<label class="required">Class Name <small>(for example, MySiteNews)</small><?php if (isset($e['class'])) {
    ?><span class="form_error_reason">Class Already Exists</span><?php 
} ?></label>
    ...
    ?>
		        	<li>
		        		<a href="#<?=$class?>"<?php if ($class == 'gear') {
    ?> class="active"<?php 
}
