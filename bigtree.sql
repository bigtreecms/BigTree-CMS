...
CREATE TABLE `bigtree_settings` (`id` varchar(255) NOT NULL DEFAULT '',`value` longtext NOT NULL,`type` varchar(255) NOT NULL,`name` varchar(255) NOT NULL DEFAULT '',`description` text NOT NULL,`locked` char(2) NOT NULL,`system` char(2) NOT NULL,`encrypted` char(2) NOT NULL,`package` int(11) unsigned NOT NULL,PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
