...
CREATE TABLE `bigtree_module_groups` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `route` varchar(255) NOT NULL, `position` int(11) NOT NULL DEFAULT '0', `extension` varchar(255) DEFAULT NULL, PRIMARY KEY (`id`), KEY `route` (`route`), KEY `position` (`position`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
