...
<div class="container">
	<section>
		...
		<p><?=Text::translate('For more information on building an extension, visit the <a href=":documentation_link:" target="_blank">BigTree Developer Documentation</a>.', false, [":documentation_link:" => "http://www.bigtreecms.org/docs/dev-guide/advanced/extensions/"])?></p>
	</section>
	<footer>
