...
<div class="container">
	<form method="post" action="<?=DEVELOPER_ROOT?>geocoding/bing/activate/">
		...
		<section>
			<p>To use the Bing Maps Geocoder API you will need a Bing Maps Key. To acquire a key, please reference <a href="http://msdn.microsoft.com/en-us/library/ff428642.aspx" target="_blank">Getting a Bing Maps Key</a>.</p>
			<hr />
			<fieldset>
