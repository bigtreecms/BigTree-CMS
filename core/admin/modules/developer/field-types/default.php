...
<script>
	$(".icon_delete").click(function() {
		BigTreeDialog({
			...
			content: '<p class="confirm">Are you sure you want to delete this field type?<br /><br />Deleting a field type also deletes its draw, process, and settings files.<br /><br />Fields using this type will revert to text fields.</p>',
			icon: "delete",
