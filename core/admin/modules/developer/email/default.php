...
<div class="container">
    ...
    ?>
			<a href="#<?=$key?>_tab"<?php if ($key == $email_service->Service) {
    ?> class="active"<?php 
}
    ?>><?=$val?></a>
			<?php 
	...
	<section id="local_tab"<?php if ($email_service->Service != 'local') {
	...
	<section id="mandrill_tab"<?php if ($email_service->Service != 'mandrill') {
    ?> style="display: none;"<?php 
} ?>>
	...
	<section id="mailgun_tab"<?php if ($email_service->Service != 'mailgun') {
    ?> style="display: none;"<?php 
} ?>>
	...
	<section id="postmark_tab"<?php if ($email_service->Service != 'postmark') {
    ?> style="display: none;"<?php 
} ?>>
	...
	<section id="sendgrid_tab"<?php if ($email_service->Service != 'sendgrid') {
    ?> style="display: none;"<?php 
} ?>>
