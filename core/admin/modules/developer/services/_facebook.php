<?php
	...
	$scope_help = Text::translate(' <small>(see <a href=":scope_link:" target="_blank">Permissions</a>)</small>', false, [":scope_link:" => "https://developers.facebook.com/docs/facebook-login/permissions/v2.6"]);
	$instructions = [
		Text::translate('<a href=":facebook_link:" target="_blank">Add a new Facebook app</a>.', false, [":facebook_link:" => "https://developers.facebook.com/apps/"]),
		...
		Text::translate('Under Facebook Login, find the Client OAuth Settings section and add :redirect_uri: as a valid OAuth redirect URI.', false, [":redirect_uri:" => "DEVELOPER_ROOT.'services/facebook/return/"]),
