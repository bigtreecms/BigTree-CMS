<?php
	...
	$bigtree["nav_tree"] = [
		...
		"developer" => ["title" => "Developer", "link" => "developer", "icon" => "developer", "nav_icon" => "developer", "level" => 2, "related" => true, "children" => [
			...
			["title" => "Content Generator", "link" => "developer/content-generator", "icon" => "edit_page", "hidden" => true],
			["title" => "Cron & Daily Digest", "link" => "developer/cron-digest", "icon" => "pending", "hidden" => true]
		]],
	...
	$bigtree["nav_tree"] = Utils::runHooks("menu", null, $bigtree["nav_tree"]);
