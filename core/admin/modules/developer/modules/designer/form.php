...
<div class="container">
    ...
    ?> style="display: none;"<?php 
		...
		<section id="field_area" class="sub">
			<fieldset<?php if (isset($e['fields'])) {
    ?> class="form_error"<?php 
} ?>>
				<label class="required">Fields<?php if (isset($e['fields'])) {
    ?><span class="form_error_reason">One Or More Fields Required</span><?php 
} ?></label>
...
<script>
	...
	$(".add_field").click(function() {
		...
		var li = $('<li id="row_' + c + '">');
		li.html('<section class="developer_resource_form_title"><span class="icon_sort"></span><input type="text" name="titles[' + c + ']" value="" class="required" /></section><section class="developer_resource_form_subtitle"><input type="text" name="subtitles[' + c + ']" value="" /></section><section class="developer_resource_type"><select name="type[' + c + ']" id="type_' + c + '"><optgroup label="Default"><?php foreach ($types['default'] as $k => $v) {
    ...
    ?></optgroup><?php 
} ?></select><a href="#" class="options icon_settings" name="' + c + '"></a><input type="hidden" name="options[' + c + ']" value="" id="options_' + c + '" /></section><section class="developer_resource_action"><a href="#" class="icon_delete" name="' + c + '"></a></section>');
