	...
	<form method="post" action="<?=DEVELOPER_ROOT?>modules/create/" class="module">
		<section>
			...
			<fieldset class="developer_module_group">
				...
				<input id="module_field_group_new" name="group_new" type="text" placeholder="<?=Text::translate("New Group", true)?>" value="<?=Text::htmlEncode($group_new)?>" /><span><?=Text::translate("OR")?></span>
