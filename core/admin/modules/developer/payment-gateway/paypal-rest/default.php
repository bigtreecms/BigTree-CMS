		...
		<section>
			...
			<fieldset>
				...
				<select name="paypal-rest-environment">
					...
					<option value="test"<?php if (!empty($gateway->Settings["paypal-rest-environment"]) && $gateway->Settings["paypal-rest-environment"] == "test") { ?> selected="selected"<?php } ?>>Test</option>
				</select>
			</fieldset>
		</section>
		<footer>
