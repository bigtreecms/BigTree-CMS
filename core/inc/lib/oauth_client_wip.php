<?
	/*
		Class: BigTreeOAuth
			OAuth authentication implementation for BigTree's Service APIs.
			Based heavily on oauth_client.php v1.58 © Manuel Lemos 2012 (BSD License)
	*/
	...
	class BigTreeOAuth {
		...
		var $Exit = false;
		var $DebugOutput = "";
		var $DebugPrefix = "BigTreeOAuth: ";
		var $Server = "";
		var $RequestTokenURL = "";
		var $DialogURL = "";
		var $OfflineDialogURL = "";
		var $AppendStateToRedirectURI = "";
		var $AccessTokenURL = "";
		var $OAuthVersion = "2.0";
		var $URLParameters = false;
		var $AuthorizationHeader = true;
		var $TokenRequestMethod = "GET";
		...
		var $OAuthUserAgent = 'BigTree CMS 4.0 (http://www.bigtreecms.org)';
